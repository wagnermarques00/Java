 ...
 * *** If you caused an arithmetic exception error inside the for structure in method2, the output will be as below ***
 *
 * Start of the main
 * Start of the method1
 * Start of the method2
 ...
 * *** If you caused a null pointer exception error inside the for structure in method2, the output will be as below ***
 *
 * Start of the main
 * Start of the method1
 * Start of the method2
